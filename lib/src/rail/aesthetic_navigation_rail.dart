...
///
/// The appearance of all of the [AestheticNavigationRail]s within an app can be
...
///
/// {@tool dartpad}
/// This example shows a [AestheticNavigationRail] used within a Scaffold with 3
/// [AestheticNavigationRailDestination]s. The main content is separated by a divider
...
///
/// {@tool dartpad}
/// This sample shows the creation of [AestheticNavigationRail] widget used within a Scaffold with 3
/// [AestheticNavigationRailDestination]s, as described in: https://m3.material.io/components/navigation-rail/overview
///
...
///    [Scaffold.body] slot.
///  * [AestheticNavigationRailDestination], which is used as a model to create tappable
...
class AestheticNavigationRail extends StatefulWidget {
  ...
  /// true when the [labelType] is null or [AestheticNavigationRailLabelType.none].
  ///
  ...
  const AestheticNavigationRail({
    ...
    this.onDestinationHover,
    this.onDestinationEnter,
    this.onDestinationExit,
    this.elevation,
    this.groupAlignment,
    this.labelType,
  ...
  /// Sets the color of the Container that holds all of the [AestheticNavigationRail]'s
  /// contents.
  ///
  ...
  /// Indicates that the [AestheticNavigationRail] should be in the extended state.
  ///
  ...
  /// must be set to [AestheticNavigationRailLabelType.none].
  ///
  ...
  ///
  /// The trailing widget is placed below the last [AestheticNavigationRailDestination].
  ...
  /// navigation rail.
  ///
  /// The value must be a list of two or more [AestheticNavigationRailDestination]
  /// values.
  final List<AestheticNavigationRailDestination> destinations;

  /// The index into [destinations] for the current selected
  /// [AestheticNavigationRailDestination] or null if no destination is selected.
  final int? selectedIndex;

  /// Called when one of the [destinations] is selected.
  ///
  /// The stateful widget that creates the navigation rail needs to keep
  /// track of the index of the selected [AestheticNavigationRailDestination] and call
  /// `setState` to rebuild the navigation rail with the new [selectedIndex].
  final ValueChanged<int>? onDestinationSelected;

  /// Called when one of the [destinations] is hovered using mouse.
  final void Function(int index, PointerHoverEvent event)? onDestinationHover;

  /// Called when one of the [destinations] is mouse enters destination region.
  final void Function(int index, PointerEnterEvent event)? onDestinationEnter;

  /// Called when one of the [destinations] is mouse exits destination region.
  final void Function(int index, PointerExitEvent event)? onDestinationExit;
  ...
  ///
  /// The [AestheticNavigationRailDestination]s are grouped together with the [trailing]
  ...
  /// [AestheticNavigationRailLabelType.none].
  ///
  /// See also:
  ///
  ///   * [AestheticNavigationRailLabelType] for information on the meaning of different
  ///   types.
  ...
  ///
  /// When a [AestheticNavigationRailDestination] is not selected,
  ...
  /// a copy of the [IconThemeData.fallback] with a custom [AestheticNavigationRail]
  ...
  /// [AestheticNavigationRailLabelType.none], or a [StadiumBorder] if [labelType] is
  /// [AestheticNavigationRailLabelType.all] or [AestheticNavigationRailLabelType.selected].
  ///
  /// If `null`, defaults to [NavigationRailThemeData.useIndicator]. If that is
  /// `null`, defaults to [ThemeData.useMaterial3].
  final bool? useIndicator;

  /// Overrides the default value of [AestheticNavigationRail]'s selection indicator color,
  ...
  /// Overrides the default value of [AestheticNavigationRail]'s selection indicator shape,
  /// when [useIndicator] is true.
  ///
  ...
  /// Returns the animation that controls the [AestheticNavigationRail.extended] state.
  ///
  ...
  /// [AestheticNavigationRail].
  ///
  /// An instance of `MyNavigationRailFab` is created for [AestheticNavigationRail.leading].
  /// Pressing the FAB button toggles the "extended" state of the [AestheticNavigationRail].
  ///
  ...
  static Animation<double> extendedAnimation(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<
            _ExtendedAestheticNavigationRailAnimation>()!
        .animation;
  }

  @override
  State<AestheticNavigationRail> createState() =>
      _AestheticNavigationRailState();
}

class _AestheticNavigationRailState extends State<AestheticNavigationRail>
  ...
  @override
  void didUpdateWidget(AestheticNavigationRail oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final AestheticNavigationRailLabelType labelType = (widget.labelType ??
            navigationRailTheme.labelType ??
            defaults.labelType!)
        .toAestheticNavigationRailLabelType;
    ...
    return _ExtendedAestheticNavigationRailAnimation(
                      ...
                      children: <Widget>[
                        for (int i = 0; i < widget.destinations.length; i += 1)
                          _RailDestination(
                            ...
                            onHover: (event) {
                              if (widget.onDestinationHover != null) {
                                widget.onDestinationHover!(i, event);
                              }
                            },
                            onEnter: (event) {
                              if (widget.onDestinationEnter != null) {
                                widget.onDestinationEnter!(i, event);
                              }
                            },
                            onExit: (event) {
                              if (widget.onDestinationExit != null) {
                                widget.onDestinationExit!(i, event);
                              }
                            },
...
class _RailDestination extends StatelessWidget {
  ...
  final AestheticNavigationRailLabelType labelType;
  final bool selected;
  ...
  Widget build(BuildContext context) {
    ...
    switch (labelType) {
      case AestheticNavigationRailLabelType.none:
      ...
      case AestheticNavigationRailLabelType.selected:
      ...
      case AestheticNavigationRailLabelType.all:
        final double minHeight = material3 ? 0 : minWidth;
...
/// Defines the behavior of the labels of a [AestheticNavigationRail].
///
/// See also:
///
///   * [AestheticNavigationRail]
enum AestheticNavigationRailLabelType {
  /// Only the [AestheticNavigationRailDestination]s are shown.
  none,

  /// Only the selected [AestheticNavigationRailDestination] will show its label.
  ///
  /// The label will animate in and out as new [AestheticNavigationRailDestination]s are
  /// selected.
  selected,

  /// All [AestheticNavigationRailDestination]s will show their label.
  all,
}

/// Defines a [AestheticNavigationRail] button that represents one "destination" view.
///
/// See also:
///
///  * [AestheticNavigationRail]
class AestheticNavigationRailDestination {
  /// Creates a destination that is used with [AestheticNavigationRail.destinations].
  ///
  /// [icon] and [label] must be non-null. When the [AestheticNavigationRail.labelType]
  /// is [AestheticNavigationRailLabelType.none], the label is still used for semantics,
  /// and may still be used if [AestheticNavigationRail.extended] is true.
  const AestheticNavigationRailDestination({
    required this.icon,
    Widget? selectedIcon,
    this.indicatorColor,
    this.indicatorShape,
  ...
  ///
  /// To make the [AestheticNavigationRail] more accessible, consider choosing an
  ...
  ///
  /// If this icon is not provided, the [AestheticNavigationRail] will display [icon] in
  /// either state. The size, color, and opacity of the
  /// [AestheticNavigationRail.selectedIconTheme] will still apply.
  ///
  /// See also:
  ///
  ///  * [AestheticNavigationRailDestination.icon], for a description of how to pair
  ///    icons.
  ...
  ///
  /// The label must be provided when used with the [AestheticNavigationRail]. When the
  /// [AestheticNavigationRail.labelType] is [AestheticNavigationRailLabelType.none], the label is
  /// still used for semantics, and may still be used if
  /// [AestheticNavigationRail.extended] is true.
  final Widget label;
...
class _ExtendedAestheticNavigationRailAnimation extends InheritedWidget {
  const _ExtendedAestheticNavigationRailAnimation({
  ...
  @override
  bool updateShouldNotify(_ExtendedAestheticNavigationRailAnimation old) =>
  ...
  _NavigationRailDefaultsM2(BuildContext context)
      : _theme = Theme.of(context),
        ...
        super(
          ...
          groupAlignment: -1,
          labelType:
              AestheticNavigationRailLabelType.none.toNavigationRailLabelType,
          useIndicator: false,
          minWidth: 72.0,
...
extension NavigationRailLabelTypeExt on NavigationRailLabelType {
  AestheticNavigationRailLabelType get toAestheticNavigationRailLabelType {
    return AestheticNavigationRailLabelType.values[index];
  }
}

extension on AestheticNavigationRailLabelType {
  NavigationRailLabelType get toNavigationRailLabelType {
